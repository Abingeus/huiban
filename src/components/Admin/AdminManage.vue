    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
        ...
        <el-menu :default-active="activePath" class="el-menu-vertical-demo" background-color="#fff" text-color="black"
          ...
          <el-menu-item index="AddConference" @click="saveNavState('AddConference')">
            <i class="iconfont icon-shouyefill"></i>
            <span slo="title">添加会议</span>
          </el-menu-item>
          <el-menu-item index="DeleteConference" @click="saveNavState('DeleteConference')">
            <i class="iconfont icon-sousuoxiao"></i>
            <span slot="title">更改会议</span>
          </el-menu-item>
<!--          <el-menu-item index="updateConference" @click="saveNavState('updateConference')">-->
<!--            <i class="iconfont icon-guizeshezhi"></i>-->
<!--            <span slot="title">更新会议</span>-->
<!--          </el-menu-item>-->
          <el-menu-item index="AddJournal" @click="saveNavState('AddJournal')">
            <i class="iconfont icon-gonggao1"></i>
            <span slot="title">添加期刊</span>
          </el-menu-item>
          <!--          <el-menu-item index="information" @click="saveNavState('information')">-->
          <!--            <i class="iconfont icon-gerenxinxi"></i>-->
          <!--            <span slot="title">个人信息</span>-->
          <!--          </el-menu-item>-->
          <el-menu-item index="ChangeJournal" @click="saveNavState('ChangeJournal')">
            <i class="iconfont icon-tushuqikan"></i>
            <span slot="title">更改期刊</span>
          </el-menu-item>

<!--          <el-menu-item index="borrow" @click="saveNavState('borrow')">-->
<!--            <i class="iconfont icon-tushuqikan"></i>-->
<!--            <span slot="title">更新期刊</span>-->
<!--          </el-menu-item>-->
...
export default {
  ...
  methods: {
    ...
    saveNavState(activePath) {
      ...
      this.$router.push({ path: `/top_menu/AdminManage/${activePath}` });
